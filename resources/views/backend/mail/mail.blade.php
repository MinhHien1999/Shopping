        ...
        <tbody>
          ...
          <tr class="cart_item">                        
              <td class="product-name" style="text-align: center">
                <b>{{$orderDetails->sanpham_ten}}</b>
              </td>
        
              <td class="product-price" style="text-align: center">
                <b>{{number_format($orderDetails->sanpham_gia, 0,'','.').' VNĐ'}}</b>
              </td>
        
              <td class="product-quantity" style="text-align: center">
                <b class="soluong" style="text-align: center">{{$orderDetails->chitiethd_soluong}}</b>  
              </td>
        
              <td class="product-subtotal">
                <b class="amount"> {{number_format($orderDetails->chitiethd_gia, 0,'','.').' VNĐ'}}</b>
              </td>    
              {{-- @dd($orderDetail); --}}
          </tr>   
          @endforeach
