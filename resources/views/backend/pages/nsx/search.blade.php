  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title"> Danh Sách Nhà Sản Xuất Tìm Kiếm</h3>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <form role="search" class="forms-sample" action="{{URL(('/admin/nsx/search'))}}" method="get" enctype="multipart/form-data">
