  ...
  <div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title"> Danh Sách Sản Phẩm Tìm Kiếm</h3>
                ...
                <tbody>
                  @foreach ($Product as $sanpham)
                    <tr>
                      ...
                      <td style="width:15%"> 
                        {{-- <a href="{{URL('/admin/product/detail/'.$sanpham->id_sanpham)}}" title="Chi tiết">
                          <button type="button" class="btn btn-info btn-icon-text"> Chi tiết 
                          </button>
                        </a>   --}}
                        ...
                        {{-- <a href="{{URL('/admin/product/delete/'.$sanpham->id_sanpham)}}" title="Xóa"> --}}
                        <a href="javascript:void(0)" title="Xóa">
                          <button type="button" class="btn btn-danger btn-icon-text" onclick="deleteProductItem({{$sanpham->id_sanpham}})">
                            Xóa
                          </button>
                        </a>  
                      </td>
